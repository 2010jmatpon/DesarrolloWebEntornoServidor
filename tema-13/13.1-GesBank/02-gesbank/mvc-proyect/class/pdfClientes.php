...
class PDFClientes extends FPDF
{
    ...
    public function Titulo()
    {
        ...
        $this->Cell(95, 10, iconv('UTF-8', 'ISO-8859-1', 'Listado de Clientes'), 0, 0, 'C', true);
    ...
    public function Encabezado(){
        ...
        $this->Cell(65, 7, iconv('UTF-8', 'ISO-8859-1', 'Cliente'), 'B', 0, 'C', true);
        $this->Cell(45, 7, iconv('UTF-8', 'ISO-8859-1', 'Email'), 'B', 0, 'C', true);
        $this->Cell(35, 7, iconv('UTF-8', 'ISO-8859-1', 'Telefono'), 'B', 0, 'C', true);
        $this->Cell(35, 7, iconv('UTF-8', 'ISO-8859-1', 'DNI'), 'B', 1, 'C', true);
    }

    public function Contenido($clientes){
        foreach($clientes as $cliente){
            ...
            $this->Cell(10, 7, iconv('UTF-8', 'ISO-8859-1', $cliente['id']), 'B', 0, 'R');
            $this->Cell(65, 7, iconv('UTF-8', 'ISO-8859-1', $cliente['cliente']), 'B', 0, 'C');
            $this->Cell(45, 7, iconv('UTF-8', 'ISO-8859-1', $cliente['email']), 'B', 0, 'C');
            $this->Cell(35, 7, iconv('UTF-8', 'ISO-8859-1', $cliente['telefono']), 'B', 0, 'C');
            $this->Cell(35, 7, iconv('UTF-8', 'ISO-8859-1', $cliente['dni']), 'B', 1, 'C');
        }
    }
}