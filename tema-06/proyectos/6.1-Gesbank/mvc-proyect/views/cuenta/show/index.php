    ...
    <div class="container">
        ...
        <form action="<?= URL ?>cuenta/update/<?= $this->id ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" name="id_cliente" disabled>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="num_movtos" value="<?= $this->cuenta->num_movtos ?>" disabled>
            </div>
