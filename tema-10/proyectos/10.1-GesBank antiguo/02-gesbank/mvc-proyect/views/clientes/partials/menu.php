        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    ...
                    <?= in_array($_SESSION['id_rol'], $GLOBALS['clientes']['import']) ?: 'disabled' ?>"
                        href="<?= URL ?>clientes/importCSV" data-bs-toggle="modal" data-bs-target="#importar">Importar
                        CSV</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active
                    <?= in_array($_SESSION['id_rol'], $GLOBALS['clientes']['export']) ?: 'disabled' ?>"
                        href="<?= URL ?>clientes/exportAllCSV">Exportar CSV</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active
                    <?= in_array($_SESSION['id_rol'], $GLOBALS['clientes']['export']) ?: 'disabled' ?>"
